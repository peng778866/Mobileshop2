            ...
            switch (v.getId()) {
                case R.id.ib_home:
                    ...
                    if (homeFragment == null) {
                        ...
                        fragmentTransaction.add(R.id.fl_main_navigatin, homeFragment);
                    } else {
                ...
                case R.id.ib_category:
                    ...
                    if (categroyFragment == null) {
                        ...
                        fragmentTransaction.add(R.id.fl_main_navigatin, categroyFragment);
                    } else {
                ...
                case R.id.ib_cart:
                    ...
                    if (cartFragment == null) {
                        ...
                        fragmentTransaction.add(R.id.fl_main_navigatin, cartFragment);
                    } else {
                ...
                case R.id.ib_personal:
                    ...
                    if (personalFragment == null) {
                        ...
                        fragmentTransaction.add(R.id.fl_main_navigatin, personalFragment);
                    } else {
