...
import com.example.mobileshop2.common.MobileShopApp;
...
public class AdActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        String url="http://10.216.164.107:8080/MobileShop/swagger/images/b.jpg";
    ...
    private  static final String SEIP_TEXT="点击跳过 %d";
    ...
    private  Runnable jumpTread=new Runnable() {
        ...
        public void run() {
            ...
            if (c_count <= 0) {
                ...
                tv_skip.setText(String.format(SEIP_TEXT, c_count));
                c_count--;
